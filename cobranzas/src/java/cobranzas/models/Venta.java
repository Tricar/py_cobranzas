...
@NamedQueries({
    ...
    @NamedQuery(name = "Venta.findByFechareg", query = "SELECT v FROM Venta v WHERE v.fechareg = :fechareg"),
    @NamedQuery(name = "Venta.findByFechaact", query = "SELECT v FROM Venta v WHERE v.fechaact = :fechaact"),
...
public class Venta implements Serializable {
    ...
    public String toString() {
        return "cobranzas.models.Venta[ ventaPK=" + ventaPK + " ]";
    }
