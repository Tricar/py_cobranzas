...
PrimeFaces.widget.DataTable = PrimeFaces.widget.DeferredWidget.extend({SORT_ORDER: {ASCENDING: 1, DESCENDING: -1, UNSORTED: 0}, init: function (a) {
        ...
        var c, e, j = null, d = null, f = null, m = (this.cfg.resizeMode === "expand"), n = this.thead.parent();
        if (this.hasColumnGroup) {
        ...
        d.off(e).on(e, function () {
            ...
            if (h > g.top) {
                c.cloneContainer.css({position: "fixed", top: "0px"}).addClass("ui-shadow ui-sticky");
                ...
                c.cloneContainer.css({position: "absolute", top: g.top}).removeClass("ui-shadow ui-sticky")
            }
        }).off(a).on(a, function () {
...
PrimeFaces.widget.FrozenDataTable = PrimeFaces.widget.DataTable.extend({setupScrolling: function () {
        ...
        if (e) {
            var h = r.hasClass("ui-frozen-column"), k = h ? this.frozenTheadClone : this.scrollTheadClone, a = h ? this.frozenThead.parent() : this.scrollThead.parent(), d = k.parent(), u = h ? this.frozenFooterCols : this.scrollFooterCols, t = h ? this.frozenFooterTable : this.scrollFooterTable, f = this;
            if (c) {
                if (b) {
